...
public class Utility extends BaseClass 
{
	...
	/*public void applyFluentWait(WebDriver driver, WebElement element) 
	{
		...
		WebElement click = wait.until(new Function<WebDriver, WebElement>() 
		{
	...
	public static String screenShot(WebDriver driver, String name) throws IOException 
	{
		...
		String currentTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern(name));
		String destination = projectPath+"//screenshots//"+name+currentTime+".png";
